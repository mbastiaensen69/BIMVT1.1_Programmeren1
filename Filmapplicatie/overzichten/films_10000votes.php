<?php
	...
	$sql = "SELECT * FROM films,reviews WHERE films.id = reviews.film_id AND num_votes > 10000 ORDER BY num_votes ASC"; //de query
	...
	if($aantal_rijen > 0) { //controle of er rijen in de database gevoinden zijn
        ...
        echo "<th style='width:5%; text-align:left;'>Number of Votes</th>";

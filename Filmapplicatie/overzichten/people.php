<?php
	...
	if($aantalRijen > 0) { //controle of er rijen in de database gevoinden zijn
        ...
        echo "<table>";
        echo "<tr>";
        echo "<th style='width:30%; text-align:left;'>Name</th>";
        echo "<th style='width:35%; text-align:left;'>Birthday</th>";
        echo "<th style='width:20%; text-align:left;'>Deathdate</th>";
...
//            echo "<div>";
            echo "<tr>";
            echo "<td >";
            echo "<a href='../formulieren/people_update.php?id=" . $rij['id']."'>", $rij['name']."</a>";
            //echo $rij['name'];
            echo "</td><td>";
            ...
            echo $rij['deathdate'];
            echo "</td><td>";
            echo "<a href='../acties/people_verwijder_actie.php?id=" . $rij['id'] . "'>Verwijderen</a>";
            echo "</td>";
            echo "</tr>";
		}
        echo "</div>";

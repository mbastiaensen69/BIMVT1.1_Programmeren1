<?php
	...
	$sql = "SELECT DISTINCT(name),birthdate,deathdate,people.id AS person_id FROM people,roles WHERE people.id = roles.person_id AND ( role = 'Director' OR role = 'director')"; //de query

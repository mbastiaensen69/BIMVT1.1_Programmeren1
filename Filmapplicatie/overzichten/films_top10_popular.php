<?php
	...
	$sql = "SELECT * FROM films,reviews WHERE films.id = reviews.film_id ORDER BY imdb_score DESC LIMIT 10"; //de query
	...
	if($aantal_rijen > 0) { //controle of er rijen in de database gevoinden zijn
        ...
        echo "<th style='width:10%; text-align:left;'>Review score (imdb)</th>";

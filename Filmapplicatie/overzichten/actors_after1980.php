<?php
    ...
    $sql = "SELECT DISTINCT(name),birthdate,deathdate,people.id AS person_id FROM people,roles 
                   WHERE people.id = roles.person_id AND ( role = 'Actor' OR role = 'actor')
                   AND birthdate > '1980-12-31' ORDER BY birthdate ASC"; //de query

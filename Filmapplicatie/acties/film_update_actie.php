...
<?php
    ...
    //de query maken met de variabelen erin
    $query = "UPDATE films SET title='$title', language='$language', duration='$duration', country='$country', 
                release_year='$release_year', gross='$gross', budget='$budget', certification='$certification' 
                WHERE id = '$id'";
    ...
    if($bewerkte_rijen > 0) {
        echo "Deze film: -- ". $title . "-- is aangepast.";
    } else {
